...
@section Introduction to our Number System program
@details It converts a decimal number to other types of numeral system (binary,octal,hexa)
@param Every value that you are getting into computer memory has a defined number system, so i made this conversion number system
